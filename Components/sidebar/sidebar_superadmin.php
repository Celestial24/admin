    ...
    <div id="sidebar" class="bg-gray-800 text-white w-64 min-h-screen flex flex-col overflow-hidden">
        ...
        <nav class="flex-1 px-2 py-4 space-y-2">
            ...
            <div id="reports-submenu" class="ml-9 space-y-1 hidden">
                <a href="/admin/reports/facilities-report.php" class="block px-3 py-1 rounded-md hover:bg-gray-700 <?= $currentPage === 'facilities-report.php' ? 'bg-gray-700' : '' ?>">
                    📊 Facilities Report
                </a>
                <a href="/admin/reports/visitor-report.php" class="block px-3 py-1 rounded-md hover:bg-gray-700 <?= $currentPage === 'visitor-report.php' ? 'bg-gray-700' : '' ?>">
                    👥 Visitor Logs Report
                </a>
                <a href="/admin/reports/audit-trail.php" class="block px-3 py-1 rounded-md hover:bg-gray-700 <?= $currentPage === 'audit-trail.php' ? 'bg-gray-700' : '' ?>">
                    🔍 Audit Trail Report
                </a>
            </div>
