...
INSERT INTO `users` (`id`, `name`, `email`, `receiver_email`, `password_hash`, `verification_code`, `is_verified`, `created_at`, `role`, `department`) VALUES
(37, 'linbil celestre', 'marvin@gmail.com', NULL, '$2y$10$FjrH4meEOmJIayYQaIu2V.4r7MQAS4kv8owNJlLU1uhCZtkuajZR.', '', 1, '2025-09-10 15:26:51', 'user', 'HR1');
