...
// ✅ Normalize session (make structure consistent)
...
$wekaConn = $conn; // reuse existing connection
?>
<!doctype html>
<html lang="en">
<head>
...
<body class="flex h-screen bg-gray-100 text-gray-800">
  ...
  <main id="mainContent" class="ml-64 flex flex-col flex-1 overflow-hidden">
    ...
    <!-- Header -->
    <header class="flex items-center justify-between border-b pb-4 px-6 py-4 bg-white">
      <h1 class="text-2xl font-semibold">Contract Result & Risk Analysis</h1>
      <div class="flex items-center gap-3">
        <?php include __DIR__ . '/../profile.php'; ?>
        <a href="contract.php" id="btnOpenUpload"
        ...
        <button id="btnAlerts"
          ...
          Alerts
          <span id="alertsCount"
                class="ml-2 inline-block bg-white text-red-600 px-2 rounded-full text-sm">0</span>
        </button>
      </div>
    </header>
    ...
    <section class="flex-1 overflow-y-auto p-6">
      <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <!-- Contracts Table -->
        <div class="col-span-1 lg:col-span-3 bg-white rounded-lg shadow p-4">
